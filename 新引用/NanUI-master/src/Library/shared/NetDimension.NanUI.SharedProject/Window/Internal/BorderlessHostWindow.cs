using NetDimension.Formium.Common.Window;
...
{
    [ToolboxItem(false)]
    internal class BorderlessHostWindow : FormNew, IBorderlessHostWindowStyle
    {
        ...
        public static explicit operator BorderlessHostWindow(FormNew v)
        {
